...
<!--	<header> CyberLawArchive.org </header> -->
	<body>
		...
		<div class="nav-bar">
			<hr/>
			<ul class="nav-bar">
				<li class="nav-bar current"><a class="nav-link" href="./intl.php"> International </a></li>
		...
		<div class="row main">
			...
			<ul>
				<li><h1>International</h1></li>
				<li><p><b> Laws, policies, and agreements that span borders.</b></p></li>
			</ul>
			</div>
